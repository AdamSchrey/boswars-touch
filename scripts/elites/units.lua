...
--
--	$Id: units.lua,v 1.10 2004/02/20 17:39:37 n0body Exp $
...
DefineUnitType("unit-plate1", {
	...
	Costs = {"time", 10, "titanium", 25, "crystal", 0, "gas", 0},
	RepairHp = 1, RepairCosts = {"titanium", 1},
	Construction = "construction-plate",
	Speed = 0, HitPoints = 25, DrawLevel = 1, TileSize = {1, 1}, BoxSize = {36, 36},
	SightRange = 0, Armor = 10, BasicDamage = 0, PiercingDamage = 0, Missile = "missile-none",
	Priority = 20, AnnoyComputerFactor = 45,
	Points = 15, Corpse = {"build-dead-body7", 0},
	Type = "land", Building = true, BuilderOutside = true,
	Sounds = {
...
DefineUnitType("unit-apcs", {
	...
	Costs = {"time", 200, "titanium", 400, "crystal", 50, "gas", 50},
	Speed = 15, HitPoints = 200, DrawLevel = 25, TileSize = {1, 1},
	BoxSize = {96, 96}, SightRange = 5,
	ComputerReactionRange = 5, PersonReactionRange = 5,
	Armor = 6, BasicDamage = 5, PiercingDamage = 5, Missile = "missile-none",
	MaxAttackRange = 4, Priority = 60, Points = 50,
	Transporter = true, AttackFromTransporter = true, MaxOnBoard = 4,
...
DefineUnitType("unit-medic", {
	...
	Costs = {"time", 300, "titanium", 400, "crystal", 50},
...
DefineUnitType("unit-bazoo", {
	...
	Costs = {"time", 200, "titanium", 250, "crystal", 150},
...
DefineUnitType("unit-assault", {
	...
	Armor = 3, BasicDamage = 5, PiercingDamage = 5, Missile = "missile-none",
...
DefineUnitType("unit-engineer", {
	...
	Costs = {"time", 100, "titanium", 175, "crystal", 25},
...
DefineUnitType("unit-harvester", {
	...
	Costs = {'time', 250, 'titanium', 500, 'crystal', 300, 'gas', 100},
...
DefineUnitType("unit-dorcoz", {
	...
	Costs = {"time", 100, "titanium", 600}, Speed = 10,
...
DefineUnitType("unit-msilo", {
	...
	Costs = {"time", 1000, "titanium", 5000, "crystal", 5000, "gas", 500},
	RepairHp = 2, RepairCosts = {"titanium", 2},
...
DefineUnitType("unit-gen", {
	...
	Costs = {"time", 200, "titanium", 300, "crystal", 30, "gas", 50},
...
DefineUnitType("unit-camp", {
	...
	Costs = {"time", 300, "titanium", 600, "crystal", 150},
	RepairHp = 2, RepairCosts = {"titanium", 2},
...
DefineUnitType("unit-vault", {
	...
	Costs = {"time", 500, "titanium", 1000, "crystal", 1000, "gas", 0},
...
DefineUnitType("unit-rfac", {
	...
	Costs = {"time", 300, "titanium", 500, "crystal", 300},
...
DefineUnitType("unit-hosp", {
	...
	Costs = {"time", 300, "titanium", 800, "crystal", 300},
...
DefineUnitType("unit-vfac", {
	...
	Costs = {"time", 500, "titanium", 800, "crystal", 700},
