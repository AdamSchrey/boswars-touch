...
--
--	$Id: units.lua,v 1.4 2004/02/01 11:45:05 n0body Exp $
...
DefineUnitType("unit-apcs", {
	...
	Transporter = true, MaxOnBoard = 4,	Type = "land",
...
DefineUnitType("unit-medic", {
	...
	Costs = {"time", 500, "titanium", 400, "crystal", 50},
...
DefineUnitType("unit-bazoo", {
	...
	Costs = {"time", 400, "titanium", 250, "crystal", 150},
...
DefineUnitType("unit-grenadier", {
	...
	Costs = {"time", 300, "titanium", 200, "crystal", 100},
	Speed = 10, HitPoints = 50, DrawLevel = 25,
...
DefineUnitType("unit-engineer", {
	...
	Costs = {"time", 150, "titanium", 175, "crystal", 25},
...
DefineUnitType("unit-harvester", {
	...
	Costs = {'time', 550, 'titanium', 500, 'crystal', 300, 'gas', 100},
	RepairHp = 2, RepairCosts = {"titanium", 2},
	ExplodeWhenKilled = "missile-160x128-explosion",
	Speed = 5, HitPoints = 800, DrawLevel = 40, TileSize = {1, 1}, BoxSize = {63, 63},
	SightRange = 5, ComputerReactionRange = 6, PersonReactionRange = 4,
...
DefineUnitType("unit-msilo", {
	...
	Costs = {"time", 1000, "titanium", 1500, "crystal", 1500, "gas", 500},
	RepairHp = 2, RepairCosts = {"titanium", 2},
...
DefineUnitType("unit-gen", {
	...
	Costs = {"time", 250, "titanium", 300, "crystal", 30, "gas", 50},
...
DefineUnitType("unit-camp", {
	...
	Costs = {"time", 400, "titanium", 600, "crystal", 150},
	RepairHp = 2, RepairCosts = {"titanium", 2},
...
DefineUnitType("unit-vault", {
	...
	Costs = {"time", 1000, "titanium", 1000, "crystal", 1000, "gas", 0},
...
DefineUnitType("unit-rfac", {
	...
	Costs = {"time", 500, "titanium", 500, "crystal", 300},
...
DefineUnitType("unit-vfac", {
	...
	Costs = {"time", 900, "titanium", 800, "crystal", 700},
