...
--
--	ui.ccl		-	Define the terras user interface
--
...
DefineCursor({
	Name = "cursor-point",
	Race = "terras",
	File = "terras/ui/terras_claw.png",
	HotSpot = {3, 2}, 
	Size = {26, 32}})
...
function DefineTerrasScreen(screen_width, screen_height)
	info_panel_x = screen_width - 200
	info_panel_y = 160
	icon_size = {46, 38}

	DefineUI("terras", screen_width, screen_height,
		"normal-font-color", "light-green",
		"reverse-font-color", "yellow",
		"filler", {
			"file", "graphics/terras/ui/ui_" .. screen_width .. "_filler.png",
			"pos", {0, 0}},
		"resource-line",
			{"graphics/terras/ui/ui_" .. screen_width .. "_respanel.png", 0, 0},
		"resources", {
			"titanium", {
				"file", "graphics/terras/ui/ui_res_icons.png", "row", 0,
				"pos", {67 +   0, 0}, "size", {14, 14}, "text-pos", {85 +   0, 1}},
			"crystal", {
				"file", "graphics/terras/ui/ui_res_icons.png", "row", 1,
		...
		"info-panel", {
			"panel", {
				"file", "graphics/terras/ui/ui_info.png",
			...
			"upgrading", {
				...
				"icon", {"pos", {info_panel_x + 107, info_panel_y + 8 + 70}, "size", icon_size}},
			"researching", {
				"text", {
					"text", "Researching:",
					"font", "game",
		...
		"button-panel", {
			"panel", {
				"file", "graphics/terras/ui/ui_" .. screen_width .. "_bpanel.png",
		...
		"map-area", {
			...
			"size", {
				...
				math.floor((screen_width - 32) / 32) * 32}},
		"menu-panel", {
			"menu-button", {
			...
			"network-diplomacy-button", {
				"pos", {screen_width - 128, 2}, "size", {80, 19},
				"caption", "Diplomacy", "style", "network"}},
		"minimap", {
			"file", "graphics/terras/ui/ui_minimap.png",
			"panel-pos", {screen_width - 200, 24},
			"pos", {screen_width - 200 + 46, 24 + 17},
			"size", {121, 105}},
		"status-line", {
			"file", "graphics/terras/ui/ui_" .. screen_width .. "_stat.png",
...
DefineTerrasScreen(640, 480)
DefineTerrasScreen(800, 600)
DefineTerrasScreen(1024, 768)
DefineTerrasScreen(1280, 960)
DefineTerrasScreen(1600, 1200)
